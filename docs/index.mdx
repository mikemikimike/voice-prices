...
**50 providers, 1,298 priced models.** 78 speech-to-text, 88 text-to-speech, 8 speech-to-speech, 2 voice activity detection, 3 bundled voice agent, and 1,104 LLM.
{/* generated:catalog-counts end */}

{/* generated:api-coverage start */}
**17 of 1,298 priced models** are published by their vendor at a machine-readable endpoint, so this catalog re-reads and compares them automatically. The providers are Cerebras and Telnyx. Every other rate is read off a pricing page by a person. [Serving an endpoint](/pricing-feed) is the single most useful thing a provider can do here.
